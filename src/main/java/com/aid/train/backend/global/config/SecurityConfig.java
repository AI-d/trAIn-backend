...
import com.aid.train.backend.global.security.filter.RefreshRateLimitFilter;
...
public class SecurityConfig {
    ...
    /**
     * DaoAuthenticationProvider에 PasswordEncoder를 등록하여
     * Form Login 등 표준 인증 흐름에서 동일한 인코더를 사용하도록 구성합니다.
     */
    @Bean
