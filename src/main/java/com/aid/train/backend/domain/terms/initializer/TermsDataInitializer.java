...
public class TermsDataInitializer {
    ...
    private String getTermsOfServiceContent() {
        return """
                ...
                ## 제1조 (목적)
                본 약관은 trAIn(이하 "회사")이 제공하는 AI 면접 연습 서비스(이하 "서비스")의 이용조건 및 절차를 정함을 목적으로 합니다.
                
                ## 제2조 (정의)
                1) "서비스"란 회사가 제공하는 AI 면접 연습 및 그 부가 기능 일체를 말합니다.
                2) "회원"이란 본 약관에 동의하고 회사와 이용계약을 체결한 자를 말합니다.
                3) "시나리오"란 회사가 제공하는 면접 연습 상황을 말합니다.
                ...
                3) AI 면접 연습 과정에서 생성되는 음성 및 텍스트 데이터는 서비스 개선을 위해 활용될 수 있습니다.
                ...
                3) AI 면접 피드백은 참고용이며, 실제 면접 결과를 보장하지 않습니다.
